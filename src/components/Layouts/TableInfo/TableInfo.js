            ...
            <div className="row ">
                    ...
                    <table className="table table-borderless">
                        <tbody>
                            <tr className="border-right">
                                <th scope="row"><span style={{ fontSize: "4em", color: "#6c757d" }}><i className="fas fa-dolly"></i></span></th>
                                <td className="mt-4">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <table className="table table-borderless">
                        <tbody>
                            <tr className="border-right">
                                <th scope="row"><span style={{ fontSize: "4em", color: "#6c757d" }}><i className="fas fa-credit-card"></i></span></th>
                                <td>
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <table className="table table-borderless">
                        <tbody>
                            <tr className="border-right ">
                                <th scope="row"><span style={{ fontSize: "4em", color: "#6c757d" }}><i className="fas fa-gift"></i></span></th>
                                <td className="mt-4">
                ...
                <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <table className="table table-borderless">
                        <tbody>
                            <tr className="border-right">
                                <th scope="row"><span style={{ fontSize: "4em", color: "#6c757d" }}><i className="fas fa-tags"></i></span></th>
                                <td className="mt-4">
