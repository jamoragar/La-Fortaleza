...
import { RegionesYcomunas } from "./comunas";
...
const CheckOut = () => {
  ...
  const generarPedido = (e) => {
    ...
    const tokenPedido = firebase
      .database()
      .ref(`/Users/${user.uid}`)
      .child("pedidos")
      .push().key; //generamos una id unica para nuestro nodo, que a la vez usaremos como control interno
  ...
  result.then((data) => {
    data.map((stock, i) => {
      if (stock <= 0) {
        ...
        alert(
          `El producto: "${orders.state.order[i].title}". Ha sido removido de su lista por encontrarse Sin Stock. Disculpe las molestias.`
        );
      }
    });
  });
  ...
  if (orders.state.order.length === 0) {
    return (
      <div style={{ margin: "5% 0 5% 0" }}>
        <h3>
          Si quieres hacer checkout, debes tener al menos un producto en tu
          carro de compras...
        </h3>
        <Link to="/">
          <Button variant="danger">
            <i className="fab fa-fort-awesome fa-2x" />
            Volver al Inicio
          </Button>
        </Link>
      </div>
    ...
    return (
      <div style={{ margin: "5% 2% 20% 2%" }}>
        <Form onSubmit={generarPedido}>
            ...
            <>
                ...
                <Col>
                  <Form.Group controlId="formLastName">
                    ...
                    <Form.Control
                      ...
                      defaultValue={userAuth.apellido}
                      required
                    />
                  </Form.Group>
                </Col>
                ...
                <Col>
                  <Form.Group controlId="formAddress">
                    ...
                    <Form.Control
                      ...
                      defaultValue={userAuth.direccion}
                      required
                    />
                  </Form.Group>
                </Col>
                  ...
                  <Form.Group controlId="formUsercomuna">
                    ...
                    >
                      <option value="0" key="alfa">
                        {userAuth.comuna ? userAuth.comuna : "Seleccione su comuna."}
                      </option>
              ...
              <Form.Group controlId="formComment">
                ...
                <Form.Control
                  ...
                  defaultValue={userAuth.comentario}
                />
              </Form.Group>
              <br />
            </>
          ...
          <h2>Su Pedido</h2>
          <br />
          ¿Desea envolver su pedido para regalo?
          <br />
          (Tiene un costo adicional de $2.000)
          <br />
                    ...
                    <td>
                      <div style={{ textAlign: "center", display: "flex" }}>
                        <h6>
                          <Button
                            onClick={() =>
                              handleCantidad(index, -1, producto.stock)
                            }
          ...
          {total >= 30001 && comuna === "Punta Arenas"? (
            <>
              <h4>Tiene envio gratuito a su dirección!</h4>
              En <b>area rural</b> le recomendamos comunicarse al número de
              contacto La Fortaleza (61) 237 1498 dentro del horario de
              atención, para confirmar el valor de este.
              <br />
            </>
          ) : (
            <>
              <h4>¿Desea servicio de reparto?</h4>
              El valor del envio es de $2.500 en <b>area urbana.</b>
              <br />
              En <b>area rural</b> le recomendamos comunicarse al número de
              contacto La Fortaleza (61) 237 1498 dentro del horario de
              atención, para confirmar el valor de este.
