...
const ArtciculosDialogs = (props) => {
  ...
  if (selectId && productView) {
    ...
    productViewToArray = productViewToArray.reduce(
            ...
            <div key={i} className="container p-3 mt-5 mb-5">
              ...
              >
                ...
                <div className="col ">
                  ...
                  <div className="row">
                    <div className="col ">
                      <div className="col pt-3">
                        <h4>Categoria: </h4>
                        <h5>{contenido.categoria}</h5>
                        <br />
                        <h4>Subcategoria: </h4>
                        <h5>{contenido.subcategoria}</h5>
                      </div>
                    </div>
                      ...
                      <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item ">
                          <h5 className="text-success">
                            {formatPrice(
                              contenido.precio -
                                contenido.precio * discountPrice
                            )}
                          </h5>
                        </li>
                        <li className="list-group-item ">
                  ...
                  <div className="row">
                    <div className="col p-3">{contenido.descripcion}</div>
                  </div>
                </div>
              </div>
                ...
                <div className="row pt-5">
                  ...
                  <div className="col-12 tabBoddy">
                    <div className="tab-content" id="myTabContent">
                      <div
                        className={`tab-pane fade show pt-5 active`}
                        id="HowToPlay"
                        role="tabpanel"
                        aria-labelledby="HowToPlay-tab"
                      >
                          ...
                          <table className="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  {contenido.ficha_tecnica.idioma_dependiente}
                                </td>
                              </tr>
                              <tr>
